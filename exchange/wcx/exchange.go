...
/***************************************************/
func CreateWcx(config *exchange.Config) *Wcx {
	once.Do(func() {
		instance = &Wcx{
			ID:      DEFAULT_ID,
			Name:    "Wcx",
			Website: "https://www.wcex.com/",
...
func (e *Wcx) GetID() int {
	return e.ID
}

func (e *Wcx) GetName() exchange.ExchangeName {
	return exchange.WCX
}

func (e *Wcx) GetTradingWebURL(pair *pair.Pair) string {
	return fmt.Sprintf("https://trading.wcex.com/trade/%s-%s", e.GetSymbolByCoin(pair.Target), e.GetSymbolByCoin(pair.Base))
}

func (e *Wcx) GetBalance(coin *coin.Coin) float64 {
...
func (e *Wcx) GetCoinConstraint(coin *coin.Coin) *exchange.CoinConstraint {
...
func (e *Wcx) SetCoinConstraint(coinConstraint *exchange.CoinConstraint) {
	coinConstraintMap.Set(fmt.Sprintf("%d", coinConstraint.CoinID), coinConstraint)
}

func (e *Wcx) GetCoins() []*coin.Coin {
	coinList := []*coin.Coin{}
	keySort := []int{}
...
func (e *Wcx) GetCoinBySymbol(symbol string) *coin.Coin {
...
func (e *Wcx) GetSymbolByCoin(coin *coin.Coin) string {
...
func (e *Wcx) DeleteCoin(coin *coin.Coin) {
	coinConstraintMap.Remove(fmt.Sprintf("%d", coin.ID))
}

/*************** Pairs on the Exchanges ***************/
func (e *Wcx) GetPairConstraint(pair *pair.Pair) *exchange.PairConstraint {
...
func (e *Wcx) SetPairConstraint(pairConstraint *exchange.PairConstraint) {
	pairConstraintMap.Set(fmt.Sprintf("%d", pairConstraint.PairID), pairConstraint)
}

func (e *Wcx) GetPairs() []*pair.Pair {
	pairList := []*pair.Pair{}
	keySort := []int{}
...
func (e *Wcx) GetPairBySymbol(symbol string) *pair.Pair {
...
func (e *Wcx) GetSymbolByPair(pair *pair.Pair) string {
...
func (e *Wcx) HasPair(pair *pair.Pair) bool {
	return pairConstraintMap.Has(fmt.Sprintf("%d", pair.ID))
}

func (e *Wcx) DeletePair(pair *pair.Pair) {
	pairConstraintMap.Remove(fmt.Sprintf("%d", pair.ID))
}

/**************** Exchange Constraint ****************/
func (e *Wcx) GetConstraintFetchMethod(pair *pair.Pair) *exchange.ConstrainFetchMethod {
...
func (e *Wcx) UpdateConstraint() {
	e.GetCoinsData()
	e.GetPairsData()
}

/**************** Coin Constraint ****************/
func (e *Wcx) GetTxFee(coin *coin.Coin) float64 {
...
func (e *Wcx) CanWithdraw(coin *coin.Coin) bool {
	coinConstraint := e.GetCoinConstraint(coin)
	if coinConstraint == nil {
		return false
	}
...
func (e *Wcx) CanDeposit(coin *coin.Coin) bool {
	coinConstraint := e.GetCoinConstraint(coin)
	if coinConstraint == nil {
		return false
	}
...
func (e *Wcx) GetConfirmation(coin *coin.Coin) int {
	coinConstraint := e.GetCoinConstraint(coin)
	if coinConstraint == nil {
		return 0
	}
...
/**************** Pair Constraint ****************/
func (e *Wcx) GetFee(pair *pair.Pair) float64 {
	pairConstraint := e.GetPairConstraint(pair)
	if pairConstraint == nil {
		return 0.0
	}
...
func (e *Wcx) GetLotSize(pair *pair.Pair) float64 {
	pairConstraint := e.GetPairConstraint(pair)
	if pairConstraint == nil {
		return 0.0
	}
...
func (e *Wcx) GetPriceFilter(pair *pair.Pair) float64 {
	pairConstraint := e.GetPairConstraint(pair)
	if pairConstraint == nil {
		return 0.0
	}
